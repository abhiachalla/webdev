    ...
    return(`
            ...
            <div class="col-xxl-9 col-xl-9 col-lg-9 col-sm-9 col-md-9 rounded-pill bg-white">
                <div class="wd-search input-form bg-white">
                    <i class="bg-white"><i class="fas fa-search pt-2"></i></i>
                    <input type="text" class="bg-white color-muted form-control" placeholder="Search Tuiter">
                </div>
           ...
           <div class="nav nav-tabs flex-md-nowwrap pt-3 " >
            ...
            <div class="card mt-2">
                <img class="card-img-top" src="https://techcrunch.com/wp-content/uploads/2019/09/Starship-Mk1-Day.jpg" alt="starship image">
