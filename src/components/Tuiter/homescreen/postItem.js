    ...
    <div className="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-10 col-10 p-1">
        ...
        <div className="p-1 ms-4" > 
            ...
            <div className="ms-2 py-3 d-flex justify-content-evenly align-items-start" >
                <a className="wd-fonts-highlight" style="text-decoration: none;"> <i className="far fa-comment"></i> <span className="wd-margin-left"> {post.comments} </span></a>
                <a className="wd-fonts-highlight ms-4" style="text-decoration: none;"> <i className="fa fa-retweet"></i> <span className="wd-margin-left"> {post.retweet} </span></a>
                <a className="wd-fonts-highlight ms-4" style="text-decoration: none;"> <span className="wd-fg-color-red"> <i className="far fa-heart"></i> </span>  <span className="wd-margin-left">{post.likes}</span></a>
